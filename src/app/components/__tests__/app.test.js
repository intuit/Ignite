...
describe('determineComponents', () => {
  ...
  test('renders nothing if no pages found', () => {
    const { SidebarComponent, Page } = determineComponents({}, { pathname: 'notFound' }, 'index.md');
  ...
  test('renders first page if it exists and no pages found', () => {
    const { SidebarComponent, Page } = determineComponents(markdown, { pathname: '/notFound' }, 'index.md');
  ...
  test('renders matching index file if filePath matches index filename pattern', () => {
    const { SidebarComponent, Page } = determineComponents(markdown, { pathname: '/index.md' }, 'index.md');
  ...
  test('render matching page if found', () => {
    ...
    const { SidebarComponent, Page } = determineComponents(markdown, { pathname: '/file.md' }, 'index.md', navItems);
  ...
  test('render matching index file in subpath', () => {
    ...
    const { SidebarComponent, Page } = determineComponents(markdown, { pathname: '/folder/file.md' }, 'index.md', navItems);
